    ...
    <div class="navbar">
        ...
        <div class="menu">
            <div class="hamburger-items">
                ...
                <div class="hamburger-items-list">
                    <a href="/admin/static"><i class="fa-solid fa-chart-column"></i> STATISTIK</a>
                </div>
                <div class="hamburger-items-list">
                    <a href="/admin/keuangan"><i class="fa-solid fa-chart-column"></i> KEUANGAN</a>
                </div>
                <div class="hamburger-items-list">
...
<div class="nav-side">
    <div class="nav-side-content">
        ...
        <div class="nav-side-link">
            <a href="/admin/home"><i class="fa-solid fa-house"></i> Dashboard</a>
            @auth
        ...
        <div class="nav-side-link-admin">
            <a href="/admin/static"><i class="fa-solid fa-chart-column"></i> STATIC</a>
            <a href="/admin/keuangan"><i class="fa-solid fa-chart-column"></i> KEUANGAN</a>
        </div>
