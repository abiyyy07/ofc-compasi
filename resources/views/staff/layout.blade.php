...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/staff-layout.css">
    ...
    <div class="navbar">
        ...
        <div class="menu">
            <div class="hamburger-items">
                ...
                <div class="hamburger-items-list">
                    <a href="/staff/list-gallery"><i class="fa-solid fa-list"></i> LIST GALLERY</a>
                </div>
                <div class="hamburger-items-list">
                    <a href="/staff/list-post"><i class="fa-solid fa-list"></i> LIST POST</a>
                </div>
                <div class="hamburger-items-list">
                    <a href="/staff/list-achievement"><i class="fa-solid fa-list"></i> LIST ACHIEVEMENT</a>
                </div>
                <div class="hamburger-items-list">
                    <a href="/staff/keuangan"><i class="fa-solid fa-list"></i> KEUANGAN</a>
                </div>
                <div class="hamburger-items-list">
                    <div class="hamburger-items-list-auth">
                    <a class="logouttt" href="{{ route('logout') }}"
